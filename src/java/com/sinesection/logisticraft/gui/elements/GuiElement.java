...
import com.sinesection.logisticraft.api.gui.events.ElementEvent;
...
public class GuiElement extends Gui implements IGuiElement {
	...
	public String toString() {
		return String.format("x%dy%dw%dh%da%sv%bxO%dyO%d", getX(), getY(), width, height, align, isVisible(), xOffset, yOffset);
	}
}