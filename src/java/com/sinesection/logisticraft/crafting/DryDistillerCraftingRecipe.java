...
public class DryDistillerCraftingRecipe {
	...
	/**
	 * Makes a simple recipe that can be made in the Dry Distiller OR
	 * Fractionator.
	 * 
	 * @param input
	 * @param outputs
	...
	/**
	 * Makes a simple recipe that can in the Dry Distiller OR Fractionator, but
	 * when made in the latter, it will produce a fluid output.
	 * 
	 * @param input
	 * @param fluidOutput
	 * @param outputs
	...
	/**
	 * Makes a simple recipe that can ONLY be made in the Fractionator, and it
	 * will produce a fluid output.
	 * 
	 * @param input
	 * @param fluidOutput
	 * @param fractionatorRequired
