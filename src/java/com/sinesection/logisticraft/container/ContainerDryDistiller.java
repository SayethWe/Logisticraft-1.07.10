...
public class ContainerDryDistiller extends Container {
	...
	public ContainerDryDistiller(InventoryPlayer inventory, TileEntityDryDistiller tEntity) {
		...
		this.addSlotToContainer(new SlotFurnace(inventory.player, tEntity, 2, 114, 25)); // Output
																							// 1
		this.addSlotToContainer(new SlotFurnace(inventory.player, tEntity, 3, 132, 25)); // Output
																							// 2
		this.addSlotToContainer(new SlotFurnace(inventory.player, tEntity, 4, 114, 43)); // Output
																							// 3
		this.addSlotToContainer(new SlotFurnace(inventory.player, tEntity, 5, 132, 43)); // Output
																							// 4
