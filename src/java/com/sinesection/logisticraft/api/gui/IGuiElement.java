...
import com.sinesection.logisticraft.api.gui.events.GuiEventHandler;
import com.sinesection.logisticraft.api.gui.events.GuiEventOrigin;
...
public interface IGuiElement {
	/* Position and Size */
	/**
	 * @return the x position of this element relative to the position of its
	 *         parent.
	 */
	int getX();

	/**
	 * @return the y position of this element relative to the position of its
	 *         parent.
	 */
	int getY();
	...
	/**
	 * The alignment of the {@link IGuiElement} defines the position of the
	 * element relative to the position of its parent.
	 */
	 ...
	 *
	 * @param width
	 *            the size of the element on the x-axis.
	 * @param height
	 *            the size of the element on the y-axis.
	 */
	 ...
	 *
	 * @param xPos
	 *            the x position of this element relative to the position of its
	 *            parent.
	 * @param yPos
	 *            the y position of this element relative to the position of its
	 *            parent.
	 */
	...
	/**
	 * Sets the x position of this element relative to the position of its
	 * parent.
	 */
	void setXPosition(int xPos);

	/**
	 * Sets the y position of this element relative to the position of its
	 * parent.
	 */
	...
	/**
	 * Sets the cropped zone of this element and the element the zone is
	 * relative to.
	 *
	 * @param cropElement
	 *            The element the zone is relative to.
	 * @param cropX
	 *            The x start coordinate of the zone.
	 * @param cropY
	 *            The y start coordinate of the zone.
	 * @param cropWidth
	...
	/**
	 * @return True if {@link #setCroppedZone(IGuiElement, int, int, int, int)}
	 *         was ever called on this element.
	 */
	boolean isCropped();
	...
	/* Creation & Deletion */
	/**
	 * Called at {@link IElementGroup#add(IGuiElement)} after the element was
	 * added to the group and {@link #setParent(IGuiElement)} was called at the
	 * element.
	 *
	 * Can be used to add other element to the element if the element is an
	 * {@link IElementGroup}.
	 */
	void onCreation();

	/**
	 * Called at {@link IElementGroup#remove(IGuiElement...)} after the element
	 ...
	 *
	 * @param mouseX
	 *            The x position of the mouse relative to the parent of the
	 *            element.
	 * @param mouseY
	 *            The y position of the mouse relative to the parent of the
	 *            element.
	 */
	...
	/**
	 * The element can be hided with {@link #hide()} and be made visible again
	 * with {@link #show()}.
	 *
	...
	/**
	 * The most elements are enabled by default. Only a few elements are
	 * disabled at a certain time like buttons.
	 *
	...
	/**
	 * Clears the tooltips that were added with {@link #addTooltip(String)} and
	 * {@link #addTooltip(Collection)}. It does not remove default tooltips of
	 * an element like the fluid information of a tank or the item information
	 * of an slot element.
	 */
	void clearTooltip();

	/**
	 * Returns the tooltip that this element provides at the given mouse
	 * position.
	 *
	 * @param mouseX
	 *            The x position of the mouse relative to the parent of the
	...
	/**
	 * @return Returns the tooltips that were added with
	 *         {@link #addTooltip(String)} and {@link #addTooltip(Collection)}.
	 */
	 ...
	 * {@link #receiveEvent(GuiElementEvent)}.
	 */
	...
	/**
	 * Receives an event and distributes them to the event handlers of this
	 * element.
	 */
